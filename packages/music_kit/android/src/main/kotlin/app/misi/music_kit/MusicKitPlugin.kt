...
class MusicKitPlugin : FlutterPlugin, ActivityAware {
  ...
  // No native libraries needed. The mediaplayback AAR (which required
  // c++_shared and appleMusicSDK) was removed. Playback uses ExoPlayer.
  // musickitauth uses pure Java/Kotlin, no JNI.
