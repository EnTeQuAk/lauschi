...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    _musicSubscriptionStreamSubscription = _musicKitPlugin.onSubscriptionUpdated
        .listen((event) {
          setState(() {
    ...
    _playerStateStreamSubscription = _musicKitPlugin.onMusicPlayerStateChanged
        .listen((event) {
          setState(() {
            _playerState = event;
          });
    ...
    _playerQueueStreamSubscription = _musicKitPlugin.onPlayerQueueChanged
        .listen((event) {
          setState(() {
            _playerQueue = event;
          });
            ...
            children: [
              ...
              TextButton(
                onPressed: () async {
                  ...
                  _musicKitPlugin.musicPlayerState.then(
                    (value) => debugPrint(value.shuffleMode.name),
                  );
                },
              ...
              TextButton(
                onPressed: () async {
                  await _musicKitPlugin.setQueue(
                    albumFolklore['type'],
                    item: albumFolklore,
                  );
