...
data class TagPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "TagPigeon(handle=$handle, id=${id.contentToString()}, techList=$techList, ndef=$ndef, nfcA=$nfcA, nfcB=$nfcB, nfcF=$nfcF, nfcV=$nfcV, isoDep=$isoDep, mifareClassic=$mifareClassic, mifareUltralight=$mifareUltralight, ndefFormatable=$ndefFormatable, nfcBarcode=$nfcBarcode)"
  }
}
...
data class NdefPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "NdefPigeon(type=$type, canMakeReadOnly=$canMakeReadOnly, isWritable=$isWritable, maxSize=$maxSize, cachedNdefMessage=$cachedNdefMessage)"
  }
}
...
data class NfcAPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "NfcAPigeon(atqa=${atqa.contentToString()}, sak=$sak)"
  }
}
...
data class NfcBPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "NfcBPigeon(applicationData=${applicationData.contentToString()}, protocolInfo=${protocolInfo.contentToString()})"
  }
}
...
data class NfcFPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "NfcFPigeon(manufacturer=${manufacturer.contentToString()}, systemCode=${systemCode.contentToString()})"
  }
}
...
data class NfcVPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "NfcVPigeon(dsfId=$dsfId, responseFlags=$responseFlags)"
  }
}
...
data class IsoDepPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "IsoDepPigeon(hiLayerResponse=${hiLayerResponse?.contentToString()}, historicalBytes=${historicalBytes?.contentToString()}, isExtendedLengthApduSupported=$isExtendedLengthApduSupported)"
  }
}
...
data class MifareClassicPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "MifareClassicPigeon(type=$type, blockCount=$blockCount, sectorCount=$sectorCount, size=$size)"
  }
}
...
data class MifareUltralightPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "MifareUltralightPigeon(type=$type)"
  }
}
...
data class NdefRecordPigeon (
...
)
 {
  ...
  override fun toString(): String {
    return "NdefRecordPigeon(tnf=$tnf, type=${type.contentToString()}, id=${id.contentToString()}, payload=${payload.contentToString()})"
  }
}
