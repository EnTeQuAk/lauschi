...
class TagPigeon {
  ...
  @override
  String toString() {
    return 'TagPigeon(handle: $handle, ndef: $ndef, feliCa: $feliCa, iso15693: $iso15693, iso7816: $iso7816, miFare: $miFare)';
  }
}
...
class NdefPigeon {
  ...
  @override
  String toString() {
    return 'NdefPigeon(status: $status, capacity: $capacity, cachedNdefMessage: $cachedNdefMessage)';
  }
}
...
class Iso15693Pigeon {
  ...
  @override
  String toString() {
    return 'Iso15693Pigeon(icManufacturerCode: $icManufacturerCode, icSerialNumber: $icSerialNumber, identifier: $identifier)';
  }
}
...
class Iso7816Pigeon {
  ...
  @override
  String toString() {
    return 'Iso7816Pigeon(initialSelectedAID: $initialSelectedAID, identifier: $identifier, historicalBytes: $historicalBytes, applicationData: $applicationData, proprietaryApplicationDataCoding: $proprietaryApplicationDataCoding)';
  }
}
...
class MiFarePigeon {
  ...
  @override
  String toString() {
    return 'MiFarePigeon(mifareFamily: $mifareFamily, identifier: $identifier, historicalBytes: $historicalBytes)';
  }
}
...
class NdefQueryStatusPigeon {
  ...
  @override
  String toString() {
    return 'NdefQueryStatusPigeon(status: $status, capacity: $capacity)';
  }
}
...
class NdefPayloadPigeon {
  ...
  @override
  String toString() {
    return 'NdefPayloadPigeon(typeNameFormat: $typeNameFormat, type: $type, identifier: $identifier, payload: $payload)';
  }
}
...
class Iso7816ApduPigeon {
  ...
  @override
  String toString() {
    return 'Iso7816ApduPigeon(instructionClass: $instructionClass, instructionCode: $instructionCode, p1Parameter: $p1Parameter, p2Parameter: $p2Parameter, data: $data, expectedResponseLength: $expectedResponseLength)';
  }
}
...
class Iso15693SystemInfoPigeon {
  ...
  @override
  String toString() {
    return 'Iso15693SystemInfoPigeon(dataStorageFormatIdentifier: $dataStorageFormatIdentifier, applicationFamilyIdentifier: $applicationFamilyIdentifier, blockSize: $blockSize, totalBlocks: $totalBlocks, icReference: $icReference)';
  }
}
...
class NfcReaderSessionErrorPigeon {
  ...
  @override
  String toString() {
    return 'NfcReaderSessionErrorPigeon(code: $code, message: $message)';
  }
}
...
class NfcVasCommandConfigurationPigeon {
  ...
  @override
  String toString() {
    return 'NfcVasCommandConfigurationPigeon(mode: $mode, passIdentifier: $passIdentifier, url: $url)';
  }
}
...
class NfcVasResponsePigeon {
  ...
  @override
  String toString() {
    return 'NfcVasResponsePigeon(status: $status, vasData: $vasData, mobileToken: $mobileToken)';
  }
}
